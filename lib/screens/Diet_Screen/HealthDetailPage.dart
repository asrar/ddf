                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: new ExactAssetImage(
                        ConstantData.assetsPath + widget.healthModel.image!,
                      ),
                      fit: BoxFit.cover,
                    )),
                    child: Align(
                      ...
                      child: Padding(
                        padding: EdgeInsets.only(
                            bottom: height - getPercentSize(height, 80)),
                        child: Container(
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.only(
                          topLeft:
                              Radius.circular(getScreenPercentSize(context, 5)),
                        )),
                    child: ListView(
                      shrinkWrap: true,
