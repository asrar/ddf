...
import 'package:ddf/util/ConstantData.dart';
import 'package:ddf/util/ConstantWidget.dart';
import 'package:ddf/util/SizeConfig.dart';
          ...
          body: new Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  getCustomText('Health Tips', textColor, 1, TextAlign.center,
                      FontWeight.bold, 28),
                  // SizedBox(
                  //   height: 45.0,
                  // ),
                  ...
                  //   height: 45.0,
                  // ),
                  getCustomText("Notifications", textColor, 1, TextAlign.center,
                      FontWeight.w600, 20),
                  Padding(
                  ...
                  InkWell(
                    ...
                    child: getCustomText("Skip", textColor, 1, TextAlign.center,
                        FontWeight.w500, 18),
                  ),
                ],
              ),
